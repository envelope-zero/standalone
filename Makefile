...
.PHONY: frontend
frontend:
	docker create --name frontend-extract ghcr.io/envelope-zero/frontend:1.25.4
...
.PHONY: build
build:
	go build -ldflags "-X github.com/envelope-zero/backend/pkg/router.version=3.20.1"
