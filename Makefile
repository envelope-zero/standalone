...
# renovate: datasource=github-releases depName=golangci/golangci-lint
	go install github.com/golangci/golangci-lint/cmd/golangci-lint@v2.12.1
...
.PHONY: frontend
frontend:
	podman create --name frontend-extract ghcr.io/envelope-zero/frontend:4.2.4
...
.PHONY: build
build:
	go build -ldflags "-X github.com/envelope-zero/backend/pkg/router.version=7.1.1"
